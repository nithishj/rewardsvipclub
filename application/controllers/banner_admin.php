...
class banner_admin extends CI_Controller
{
    ...
    function addbanner()
    {
		...
		$res=$this->banner_admin_model->addbanner($json['BannerName'],$json['BannerImage'],$json['UserId']);
	   ...
	   function editbanner()
    {
		...
		{
		$this->load->model('banner_admin_model');
		$res=$this->banner_admin_model->editbanner($json['BannerId'],$json['BannerName'],$json['BannerImage'],$json['UserId']);
