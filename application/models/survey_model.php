...
Class survey_model extends CI_Model
{
	 ...
	 {
	    $thumb=base_url()."resize.php?height=50&width=50&path=";
		$q=$this->db->query("select sa.UserId,up.user_name,case when up.profile_picture is null or char_length(up.profile_picture)=0 then '' else concat('$thumb',up.profile_picture) end as profile_picture from surveyanswer sa inner join user_profile up on sa.UserId=up.user_id where sa.SurveyId='$surveyid' group by sa.UserId");
	    return $q->result();
	 }
