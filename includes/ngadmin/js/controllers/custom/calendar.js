...
app.controller('FullcalendarCtrl', ['$scope', function($scope) {
    ...
    $scope.events = [
      ...
      {title:'Dance class', start: new Date(y, m, 3), end: new Date(y, m, 5, 9, 30), allDay: false, className: ['b-l b-2x b-danger'], location:'London', info:'Two days dance training class.'},
